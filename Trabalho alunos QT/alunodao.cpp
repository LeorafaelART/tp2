...
AlunoDAO::AlunoDAO()
{
    nomeArquivo = "/Users/olegariocorreadasilvaneto/QTAlunos_Exemplo/alunos.csv";
}
//Inserir aluno no arquivo
...
Aluno* AlunoDAO::buscarArquivo(QString const &id){
    ...
    arquivo.open(nomeArquivo.toStdString().c_str());//Abrir arquivo
    if(!arquivo.is_open())
